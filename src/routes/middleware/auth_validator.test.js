...
describe('Authentication token handling', () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const authenticationResult = yield auth_validator.getLiveAuthTokens(live_access_token, live_id_token, username, password);
        live_id_token = authenticationResult.id_token;
        live_access_token = authenticationResult.access_token;
        // get a permissions token
        live_permissions_token = yield perm.buildPermissionsToken({ user_id: 'c458f4a8-c0f1-7051-261d-09cb8b007f51', access: [permissions.AccessRoles.PropertyManager] });
    }));
    it('get Cognito JSON Web public keys', () => __awaiter(void 0, void 0, void 0, function* () {
        const cognito_keys = yield auth_validator.getPublicKeys();
        const first_key = JSON.stringify(cognito_keys).split(':');
        assert(!(first_key[0] === null));
    }));
    it('Parse valid token that uses current public key', () => __awaiter(void 0, void 0, void 0, function* () {
        const cognito_keys = public_keys;
        let parsed_token = null;
        try {
            parsed_token = yield auth_validator.parseToken(live_id_token, cognito_keys);
        }
        catch (error) {
            assert(false);
            return;
    ...
    it('Parse valid token that uses older public key', () => __awaiter(void 0, void 0, void 0, function* () {
        const cognito_keys = old_public_keys;
        try {
            const parsed_token = yield auth_validator.parseToken(id_token_expired, cognito_keys);
        }
        catch (error) {
    ...
    it('Parse valid but expired id_token', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('Parse valid but expired access_token', () => __awaiter(void 0, void 0, void 0, function* () {
        // const cognito_keys = await auth_validator.getPublicKeys();
        const cognito_keys = public_keys;
        try {
            const parsed_token = yield auth_validator.parseToken(access_token_expired, cognito_keys);
        }
        catch (error) {
            assert(error.code == 'ERR_JWT_EXPIRED');
            return;
    ...
    it('Parse token with invalid signature', () => __awaiter(void 0, void 0, void 0, function* () {
        // const cognito_keys = await auth_validator.getPublicKeys();
        const cognito_keys = public_keys;
        try {
            const parsed_token = yield auth_validator.parseToken(id_token_invalid, cognito_keys);
        }
        catch (error) {
    ...
    it('Parse token with invalid payload', () => __awaiter(void 0, void 0, void 0, function* () {
        const cognito_keys = public_keys;
        try {
            const parsed_token = yield auth_validator.parseToken(access_token_invalid, cognito_keys);
        }
        catch (error) {
            assert(error.code == 'ERR_JWS_SIGNATURE_VERIFICATION_FAILED');
            return;
    ...
    it('ensure a valid token in Authorization header gets a 200 response', () => __awaiter(void 0, void 0, void 0, function* () {
        const property_id = 'ab04d63f-535f-4dfc-bc12-fc260cbf7ac4';
        const res = yield request.get('/property/' + property_id)
            .set({ Authorization: live_id_token })
            .set({ permissions: live_permissions_token }) // Add permissions token
            .expect(200);
        expect(res.body[0]).toHaveProperty('id', property_id);
    }));
    it('ensure a valid token as a cookie gets a 200 response', () => __awaiter(void 0, void 0, void 0, function* () {
        const property_id = 'ab04d63f-535f-4dfc-bc12-fc260cbf7ac4';
        const res = yield request.get('/property/' + property_id)
...
//# sourceMappingURL=auth_validator.test.js.map