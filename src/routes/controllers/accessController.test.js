...
describe('Access API', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const authenticationResult = yield auth.getLiveAuthTokens(null, null, username, password);
        live_id_token = authenticationResult.id_token;
        live_access_token = authenticationResult.access_token;
        // get a permissions token
        live_permissions_token = yield perm.buildPermissionsToken({ user_id: 'shadowed-86de-4abb-91a9-3f9e68d12fca', access: [AccessRoles.PropertyManager] });
    }));
    it('get Access information for a set of users', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const access_item = yield access_store.createItem(access);
        expect(access_item).toHaveProperty('id');
        let existing_user_id = new_user_id;
        const result = yield request.get('/access')
        ...
        const result2 = yield access_store.deleteItem(access_item.user_id);
    }));
    it('get properties already assigned to shadow manager', () => __awaiter(void 0, void 0, void 0, function* () {
        let new_user_id = uuid.v4();
        let property_manager_id = "1ec37be2-ca70-4439-be96-b3a88881de46";
        let shadow_user_id = "845f5ec2-bdf2-45b8-a87d-2f53c774db8d";
        const result = yield request.get('/list_shadow_manager_properties')
...
//# sourceMappingURL=accessController.test.js.map